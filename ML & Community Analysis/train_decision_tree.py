...
def main() -> None:
    ...
    p.add_argument("--fold", type=int, default=0, help="CV fold index")
    p.add_argument("--depth", type=int, required=True, help="DecisionTree max_depth")
    ...
    p.add_argument("--out_dir", default="models/decision_tree")
    args = p.parse_args()
